            ...
            <div class="container-fluid dashboard-content">
                <div class="row">
                    <div class="col-xl-10">
                      ...
                      @if(($count_c_s >= $get_cooperative_crop_number_of_season) && ($count_c_s > 0)) 
                                    ...
                                    <div style="border-radius:10px;" class="card">
                                     ...
                                     <div class="progress-bar progress-bar-striped bg-success progress-bar-animated" role="progressbar" style="width: 100%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">100%</div>
                                      ...
                                      <div class="card-body">
                                        ...
                                        <a style="displsy:block; margin-left:auto; margin-right:auto" href="{{ route('admin.logout') }}"   class="btn btn-success">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                <div style="border-radius:10px;"  class="card">
                                   ...
                                   @if($count_c > 0) 
                                        ...
                                        <h1 style="text-align:center" class="mb-1">{{$get_cooperative_crop_name}}</h1> </br>

                                        <h1 style="text-align:center" class="mb-1">{{$get_cooperative_crop_number_of_season}} Season(s)</h1>
...
<h5 style="text-align:center" class="text-muted">NO. OF SEASONAL DATE/CALENDAR ADDED</h5>

<h1 style="text-align:center" class="mb-1">{{$count_c_s}} out of {{$get_cooperative_crop_number_of_season}}</h1>
                                                    ...
                                                    <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="text"  onkeypress="return isNumberKey(event)"  required name="average_spacing" placeholder="Average number of planting space (cm)" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="text"  onkeypress="return isNumberKey(event)" required name="no_of_season" placeholder="Number of planting season in a year" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                                ...
                                                                                <div class="col-9 col-lg-10">
                                                                                    ...
                                                                                    <select reqiured  class="form-control" name="season_no">
                                                                                     @if(!@empty($get_cooperative_crop_number_of_season))
                                                                                 @for($i=1;$i<=$get_cooperative_crop_number_of_season;$i++)
                                                                                     <option>{{$i}}</option>
                                                                                    @endfor

                                                                                    @else 
                                                                                    <option disable>---Add crop---</option>
                                                                                        @endif
                                                                                   </select>
