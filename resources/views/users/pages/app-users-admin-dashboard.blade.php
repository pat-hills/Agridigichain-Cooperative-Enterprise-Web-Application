 ...
 <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-8 col-lg-12 col-md-8 col-sm-12 col-12">
                        <div style="border-radius:10px;" class="card">
                            <h5  style="border-radius:10px;" class="card-header">Revenue</h5>
                            <div class="card-body">
                    ...
                    <div class="col-xl-4 col-lg-12 col-md-4 col-sm-12 col-12">
                        <div  style="border-radius:10px;" class="card">
                            <h5  style="border-radius:10px;" class="card-header">Total Sale</h5>
                            <div class="card-body">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Top Harvesting Farms</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Top Infested Farms</h5>
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead class="bg-light">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Top Fertilzer Usage Farms</h5>
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead class="bg-light">
