...
<!-- 
  ...
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script> -->
    ...
    <title>AGRIdigichain | Admin | Home | Dashboard </title>
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            ...
            <img style="width: 90px; height: 80px;margin-left: 22px" alt="FBSdigichain" src="{{ url('trans_parent_logo.png') }}" />
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fas fa-home"></i>Dashboard <span class="badge badge-success">6</span></a>
...
<!-- 
                                        ...
                                        <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin_users_dashboard')}}">Overview</a>
                                        <a class="nav-link" href="{{route('admin_users_dashboard')}}">Metrics</a>
                                        <a class="nav-link" href="{{route('admin_users_dashboard')}}">Analytics</a>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#Transactions" aria-controls="submenu-4"><i class="fas fa-paper-plane"></i>Transactions</a>
                                <div id="Transactions" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                        <a class="nav-link" href="#">Freight Movements</a>
                                        </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#Activities" aria-controls="submenu-4"><i class="fas fa-leaf"></i>Farm Activities</a>
                                <div id="Activities" class="collapse submenu" style="">
                                    <ul class="nav flex-column">

                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Profiled Farmers</a>
                                        </li>

                                        <li class="nav-item">
                                        <a class="nav-link" href="#">Land Preparation</a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                        <a class="nav-link" href="#">Spraying And Weeding</a>
                                        </li>

                                        <li class="nav-item">
                                        <a class="nav-link" href="#">Fertilizer Application</a>
                                        </li>

                                        <li class="nav-item">
                                        <a class="nav-link" href="#">Harvesting</a>
                                        </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#Communications" aria-controls="submenu-4"><i class="fas fa-envelope"></i>Communications</a>
                                <div id="Communications" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#Accounting" aria-controls="submenu-4"><i class="fas fa-calculator"></i>Books And Accounting</a>
                                <div id="Accounting" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#Setups" aria-controls="submenu-4"><i class="fas fa-wrench"></i>Setups</a>
                                <div id="Setups" class="collapse submenu" style="">
                                    <ul class="nav flex-column">

                                    <li class="nav-item">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Crops And Calendars</a>
                                        </li>
                                        <a class="nav-link" href="{{route('add_farmer_based_view')}}">Cooperatives And FBO'S</a>
                                        </li>
                                        </li>
                                        <a class="nav-link"href="{{route('add_user_list_view')}}">Cooperative Users </a>
                                        </li>
                                        <li class="nav-item">
                                        <a class="nav-link" href="#">Vendors And Suppliers</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('admin.logout') }}"     ><i class="fas fa-power-off mr-2"></i>Logout</a>
